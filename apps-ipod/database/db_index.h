 ...
 *
 * On success '*handle' is the claim, and db_index_release() must be given
 ...
 * against the background pass exactly as db_index_build() does -- the index
 ...
 * the caller can fall back to building one with db_index_build_artists()
...
extern struct bg_task db_index_task;
