...
static int update_dir(void)
{
    ...
    /* Settled, because moving between lists of different row heights (tall
     * album-art rows <-> ordinary rows) is exactly what leaves the shared
     * conditionals wrong for a frame. */
