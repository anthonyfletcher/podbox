...
#undef CAROUSEL_FILTER_CHOICES
   ...
   CUSTOM_SETTING(0, root_menu_customized,
    ...
    OFFON_SETTING(0, spun_artwork, LANG_SPUN_ARTWORK, true, "spun artwork",
                  NULL),
    INT_SETTING(0, spun_top_count, LANG_SPUN_TOP_COUNT, 10, "spun top count",
                UNIT_INT, 5, 25, 5, NULL, NULL, NULL),
    CHOICE_SETTING(0, spun_badge_order, LANG_SPUN_BADGE_ORDER, 0,
                   "spun badge order", "table,earned,recent,closest", NULL, 4,
                   ID2P(LANG_SPUN_ORDER_TABLE), ID2P(LANG_SPUN_ORDER_EARNED),
                   ID2P(LANG_SPUN_ORDER_RECENT),
                   ID2P(LANG_SPUN_ORDER_CLOSEST)),
    CHOICE_SETTING(0, spun_rank_by, LANG_SPUN_RANK_BY, 0, "spun rank by",
                   "plays,minutes", NULL, 2,
                   ID2P(LANG_SPUN_RANK_PLAYS), ID2P(LANG_SPUN_RANK_MINUTES)),
