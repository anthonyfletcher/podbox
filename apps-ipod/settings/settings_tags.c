...
{ "mood playlist",             TAG_LIBRARY|TAG_PLAYLIST,         "mood journey random varied repeatable" },
{ "generated playlist length", TAG_LIBRARY|TAG_PLAYLIST,         "tracks how many size mood similar" },
{ "continue playing",          TAG_LIBRARY|TAG_PLAYLIST,         "keep going endless extend never stop" },
...
{ "spun rank by",        TAG_LIBRARY,                            "spun playback report statistics top artists songs albums ranked plays minutes time listened" },
