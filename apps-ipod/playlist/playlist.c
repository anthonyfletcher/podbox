...
/* playlist elapsed percent, implemented in skin/skin_tokens.c */
...
{
    /* Most playlists are indexed too fast to be worth a splash. Only show one
     * if we are still going after a sixth of a second, then keep it alive. */
                    ...
                    unsigned long offset)
{
    ...
    /* let %pX re-measure the playlist, if any skin asked for it */
