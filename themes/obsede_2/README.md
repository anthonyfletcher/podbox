...
- Original theme: https://themes.rockbox.org/index.php?target=ipod6g&themeid=4056
- Created by: Serge Fahnenstell
- License: CC BY-SA 3.0 (https://creativecommons.org/licenses/by-sa/3.0/deed.en)

Modified to support dynamic colours, album/artist art and the Noto Sans font.
...
Select `Settings > Appearance > Load Theme` and then `obsede_2` from the list
