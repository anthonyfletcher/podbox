...
also `rockbox/master`'s current tip. Every commit this merge brought is
settled. Two rows above it are not, both from the merge before: `30a5f1d858`
and `9cd4352256`, the quickscreen pair.
