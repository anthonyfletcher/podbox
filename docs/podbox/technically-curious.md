...
- **No plugin system.** The  handful of plugins worth keeping became ordinary core
  screens: the text and image viewers, properties, playing time, credits.  If you miss
  Doom you need  help.
...
| `firmware/` | Hardware abstraction, drivers, kernel. Close to Rockbox; See [`docs/podbox/upstream-divergence.md`](docs/podbox/upstream-divergence.md) for changes.     |
